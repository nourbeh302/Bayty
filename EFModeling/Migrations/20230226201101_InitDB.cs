        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TaxRecordImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TaxRecordNumber = table.Column<string>(name: "Tax Record Number", type: "nchar(9)", fixedLength: true, maxLength: 9, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(name: "Phone Number", type: "nvarchar(15)", maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HasElevator = table.Column<bool>(name: "Has Elevator", type: "bit", nullable: false),
                    FlatsCount = table.Column<int>(name: "Flats Count", type: "int", nullable: false),
                    FloorsCount = table.Column<int>(name: "Floors Count", type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VillaFeaturesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardNumber = table.Column<string>(name: "Card Number", type: "nchar(16)", fixedLength: true, maxLength: 16, nullable: false),
                    OwnerId = table.Column<string>(name: "Owner Id", type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Card", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Card_AspNetUsers_Owner Id",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComplainerId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ComplaineeId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reports_AspNetUsers_ComplaineeId",
                        column: x => x.ComplaineeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Reports_AspNetUsers_ComplainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RentalCost = table.Column<double>(name: "Rental Cost", type: "float", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transcations_AspNetUsers_InitiatorId",
                        column: x => x.InitiatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Transcations_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_ComplaineeId",
                table: "Reports",
                column: "ComplaineeId");

            migrationBuilder.CreateIndex(
                name: "IX_Reports_ComplainerId",
                table: "Reports",
                column: "ComplainerId");

            migrationBuilder.CreateIndex(
                name: "IX_Transcations_InitiatorId",
                table: "Transcations",
                column: "InitiatorId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Transcations_ReceiverId",
                table: "Transcations",
                column: "ReceiverId",
                unique: true);
