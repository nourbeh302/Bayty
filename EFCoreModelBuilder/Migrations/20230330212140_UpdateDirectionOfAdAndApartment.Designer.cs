...
namespace EFCoreModelBuilder.Migrations
{
    ...
    [Migration("20230330212140_UpdateDirectionOfAdAndApartment")]
    partial class UpdateDirectionOfAdAndApartment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Entities.Apartment", b =>
                {
                    b.HasOne("Models.Entities.Advertisement", "Advertisement")
                        .WithOne("Apartment")
                        .HasForeignKey("Models.Entities.Apartment", "AdvertisementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
